  ...
  return (
    <main className="social-page">
      ...
      <div className="social-stats">
        <div className="dd-kpi"><span className="dd-kpi-label">Total Posts</span><span className="dd-kpi-value">{posts.length}</span></div>
        <div className="dd-kpi"><span className="dd-kpi-label">Total Reach</span><span className="dd-kpi-value">{totalReach.toLocaleString()}</span></div>
        <div className="dd-kpi"><span className="dd-kpi-label">Total Engagement</span><span className="dd-kpi-value">{totalEngagement.toLocaleString()}</span></div>
        <div className="dd-kpi"><span className="dd-kpi-label">Boosted Posts</span><span className="dd-kpi-value">{posts.filter((p) => p.is_boosted).length}</span></div>
      </div>
